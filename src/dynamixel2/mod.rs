...
mod esp_hal {
    ...
    use core::ops::Add;
    impl<Dir: embedded_hal::digital::OutputPin> dynamixel2::SerialPort
        for Rs485Uart<'_, Dir, Blocking>
    {
    ...
    impl<Dir: embedded_hal::digital::OutputPin> dynamixel2::AsyncSerialPort
